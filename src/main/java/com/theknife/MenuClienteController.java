...
/**
 * Controller del menu cliente.
 * Gestisce la navigazione tra le funzionalità disponibili per l'utente cliente,
 * come home, impostazioni, preferiti, recensioni e logout.
 */
